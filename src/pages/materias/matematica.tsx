...
const Matematica: NextPage<{ atividade: Array<IAtividade>, files: Array<Archives>}> = props => {
    ...
    return (
        ...
        <div className={"m-5"}>
            ...
            <h1 className="mt-40 flex justify-center mb-4 text-4xl font-extrabold text-blue-600 leading-none tracking-tight md:text-5xl lg:text-6xl ">Matemática</h1>
            <p className="text-center mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 ">Aqui irei depositar os trabalhos de matemática</p>
