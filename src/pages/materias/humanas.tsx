...
const Linguagens: NextPage<{ atividade: Array<IAtividade>, files: Array<Archives>}> = props => {
    ...
    return (<>
        ...
        <h1 className="mt-40 flex justify-center mb-4 text-4xl font-extrabold text-blue-600 leading-none tracking-tight md:text-5xl lg:text-6xl ">Ciências Humanas</h1>
        <p className="text-center mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 ">Aqui irei depositar os trabalhos de ciências humanas</p>
        ...
        <br/><br/><br/><br/><br/><br/>
        {/*<p>EAE {props.atividade.map(e => e.nome)}</p>*/}
    </>)
}
...
export async function getServerSideProps() {
    let api = await fetch("http://localhost:3000/api/activitys?method=getAllActivities&materia=humanas")
